...
<body class="body">
  ...
  <div class="w-section hero question-1">
	...
	if($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		<h6 class="login-divider">Your email address or password is invalid</h6> <?php
    	}
  } ?>
      ...
      <div align = "center">
        ...
        <a href="sendresetlink.php" style="color:white; algin:center" class="deletebtn">forgot password</a>
