...
?>
<html data-wf-site="56fd24aaaea6500c763220cf" data-wf-page="571a7c2047bea114647c3613">
<head>
  <meta charset="utf-8">
...
<body class="body topics">
  ...
  <div class="w-section hero">
    <div class="w-container hero-container defence">
      <img src="images/defence-01.png" class="hero-image">
      <h1 class="hero-title word">defence.</h1>
      <h1 class="hero-title _4">Questions include:</h1>
      ...
      <a href="#top" class="w-button hero-button">Start defence &gt;</a>
      <a href="#Finish" class="w-button hero-button _2">Skip this topic</a>
    </div>
  </div>
  <div id="top" class="w-section intro-panel">
    <h1 class="grid-header">Overview - What's the story with <strong>Defence and Security:</strong></h1>
    ...
    <div class="w-row how-to-row">
      ...
      <div class="w-col w-col-4 react">
        ...
        <p class="read-para">Use the 5 emojis to react to how you feel about the information you read, press the neutral emoji to start.</p>
      </div>
  ...
  <div class="w-section tb-slider-section">
    <h1 class="topic-header">Top questions on Defence and Security</h1>
    <div data-animation="slide" data-duration="500" data-infinite="1" class="w-slider tb-slider">
      <div class="w-slider-mask tb-mask">
        <div class="w-slide slide-1">
          <div class="w-container container-tb">
            <div class="key-point-1">
              <h1 class="card-1-header too-big">Will leaving the EU have an impact on the UKs membership of international bodies?</h1>
        ...
        <div class="w-slide slide-2">
          <div class="w-container container-tb">
            <div class="key-point-2">
              <h1 class="card-2-header too-big">Does being a member of the EU make it easier to fight crime and terrorism?</h1>
        ...
        <div class="w-slide slide-3">
          <div class="w-container container-tb">
            <div class="key-point-3 too-high-2">
    ...
    <div data-ix="display-none-on-load" class="w-row argument-row">
      <div class="w-col w-col-4 overview-1">
        <div class="sticky-footer">
          ...
          <p class="basics-paragraph">This is a nice straight forward one and the answer is 'No'. The UK is a member of each organisation in its own right so leaving the EU will have no impact on the membership of any other organisation(s).
            <br>
            <br>For example if the UK withdrew from NATO it wouldn't leave the UN as well, they all work together but are unrelated.</p>
      ...
      <div class="w-col w-col-4 stay-1">
        <div class="sticky-footer">
          ...
          <p class="basics-paragraph"><span style="font-size: 18px; background-color: rgb(38, 172, 199);"><strong class="impact-answer-stay">None.</strong></span>&nbsp;
            <br>
            <br>We'd stay as we are, unless something went terribly wrong and we stopped being a major global economy.</p>
          <div class="fill-empty-space"></div>
          <div class="emoticon-div">
            <div class="how-emoticons-work">How does this make you feel?</div>
  ...
  <div id="Section-1" class="w-section section-1">
    ...
    <div data-ix="display-none-on-load" class="w-row first-column-set">
      <div class="w-col w-col-5 column-1">
        <div class="card-1">
          <div class="sticky-footer">
            ...
            <h1 id="headline" class="headline-fact-long">Terrorism, Espionage and Cyberattacks</h1>
            <h1 class="headline-small">are the 3 top threats to UK national security according to Mi5</h1>
      ...
      <div class="w-col w-col-4 column-2">
        <div class="card-2">
          <div class="sticky-footer">
            <h3 class="card-header-2">Does being a member of the EU make it easier for the UK to be attacked?</h3>
            <h1 class="headline-fact-long">Impossible to tell.</h1>
            <a href="#" data-ix="p2" class="w-button button-2">Show in&nbsp;context</a>
            <p data-ix="display-none-on-load" class="p2">This will be answered in detail here as soon as we can.</p>
        ...
        <div class="card-3">
          <div class="sticky-footer">
            ...
            <h1 class="headline-fact">5th most powerful</h1>
            <h1 class="headline-small">in the world.</h1>
            <a href="#" data-ix="p3" class="w-button button-3">More info</a>
            <p data-ix="display-none-on-load" class="p3">The UK has one of the most powerful armed forces in the world due to a mixture of factors including high expenditure, a highly trained professional standing army and access to nuclear weapons. It is also considered to be the most powerful within the EU.</p>
      ...
      <div class="w-col w-col-3 column-3">
        <div class="card-4">
          <div class="sticky-footer">
            <h1 class="card-heading-4">How much does the UK spend on defence?</h1>
            <h1 class="headline-fact">£46 billion</h1>
            <h1 class="headline-small">a year</h1>
            <a href="#" data-ix="p4" class="w-button button-4">More info</a>
            <p data-ix="display-none-on-load" class="p4">The UK is the 5th largest spender on defence in the world , totalling over £46 billion a year or 2% of the UKs GDP. This is despite it being the 21st most populated country in the world.</p>
    ...
    <div data-ix="display-none-on-load" class="w-row second-column-set">
      <div class="w-col w-col-5 cc1">
        <div class="card-5">
          <div class="sticky-footer">
            <h1 class="card-header-5">How powerful are other EU countries armed forces?</h1>
            <h1 class="headline-fact">Amongst the worlds Top 10.</h1>
            <a href="#" data-ix="p5" class="w-button button-5">More info</a>
            <p data-ix="display-none-on-load" class="p5">France and Germany rank amongst the worlds most powerful militaries with France being particularly notable given its ownership of nuclear weapons. The vast majority of EU countries are members of NATO so military efforts pooled collectively and it is highly unlikely that any member state would operate independently of another.</p>
      ...
      <div class="w-col w-col-4 cc2">
        <div class="card-6">
          <div class="sticky-footer">
            <h1 class="card-header-6">What are the current security threats to the EU?</h1>
            <h1 class="headline-fact-long">1. Terrorism<br>2. Proliferation of weapons of mass destruction (WMD)<br>3. Regional conflicts<br>4. State failure<br>5. Organised crime.</h1>
            <a href="#" data-ix="p6" class="w-button button-6">Show context</a>
            <p data-ix="display-none-on-load" class="p6">Largely speaking, the threats faced by the majority of member states are the same. The EU is a collective target for extremists, particularly those from the so called Islamic State as made clear during the horrific attacks in Paris and Brussels.</p>
            <div class="evidence"><a target="_blank" href="http://www.eeas.europa.eu/csdp/about-csdp/european-security-strategy/">Where did we get this from?</a>
            </div>
            <div class="fill-empty-space"></div>
            <div class="emoticon-div">
  ...
  <div id="Section-2" class="w-section section-2">
    <h4 class="how-to-use-the-grid-header">International co-operation</h4>
    ...
    <div data-ix="display-none-on-load" class="w-row third-column-set">
      <div class="w-col w-col-5 column-7">
        <div class="card-7">
          <div class="sticky-footer">
            <h1 class="card-heading-7">Is the EU part of NATO?</h1>
            <h1 class="headline-fact">No.</h1>
            <h1 class="headline-small">But they work closely together.</h1>
            <a href="#" data-ix="p7" class="w-button button-7">More info</a>
            <p data-ix="display-none-on-load" class="p7">The European Union is a unique and essential partner for NATO. The two organisations share a majority of members (22), and all members of both organisations share common values.</p>
      ...
      <div class="w-col w-col-4 column-8">
        <div class="card-8">
          <div class="sticky-footer">
            ...
            <h1 class="headline-small">The two are completely unrelated.</h1>
            <a href="#" data-ix="p8" class="w-button button-8">More info</a>
            <p data-ix="display-none-on-load" class="p8">The UK joined NATO in 1949, shortly after the end of the Second World War along with Belgium, the Netherlands, Luxembourg and France. The aim of NATO was for Western Europe to group together to deter aggression from the USSR. The UK is a member of both NATO and EU so leaving one won't effect the other.</p>
            <div class="evidence"><a target="_blank" href="http://www.nato.int/cps/en/natohq/topics_49217.htm">Where did we get this from?</a>
            </div>
            <div class="fill-empty-space"></div>
            <div class="emoticon-div">
      ...
      <div class="w-col w-col-3 column-9">
        <div class="card-9">
          <div class="sticky-footer test">
            <h1 class="card-header-8">What is the European Arrest Warrant?</h1>
            <h1 class="headline-fact-long">The ability to arrest a wanted person in any EU country.</h1>
            <a href="#" data-ix="p9" class="w-button button-9">More info</a>
            <p data-ix="display-none-on-load" class="p9">The European Arrest Warrant (EAW) is an arrest warrant valid throughout all member states of the European Union (EU). Once issued, it requires another member state to arrest and transfer a criminal suspect or sentenced person to the issuing state so that the person can be put on trial or complete a detention period. This is designed to speed up how quickly criminals can be deported and stand trial in the country where they committed the crime.The technicalities of what the person can be arrested for (for example the crime must warrant a year or more in prison) and how it is used will be discussed further.</p>
        ...
        <div class="card-10">
          <div class="sticky-footer">
            <h1 class="card-header-8">How many people have been arrested using the European Arrest Warrant?</h1>
            <h1 class="headline-fact large-text">Approx. 14,000</h1>
            <div class="evidence"><a target="_blank" href="http://www.nationalcrimeagency.gov.uk/publications/european-arrest-warrant-statistics">Where did we get this from?</a>
            </div>
            <div class="fill-empty-space"></div>
            <div class="emoticon-div">
  ...
  <div id="Finish" class="w-section got-the-basics topics">
    <h1 class="basics-link">Thats Defence and Security done for now</h1>
    <p class="lets-get-started-pap">It looks like you're all done with LeaveorStay for now, but please remember to comeback as we update the sight constantly.
      <br>Click the button below to go back to the home screen, feel free to go back to pages and have another read of them.
      <br>
      <br>Remember you dont have to react to every card, feel free to pick and choose what topics and cards you look at.</p>
    <a href="new-homepage.php" class="w-button continue-button">Back to home &gt;</a>
