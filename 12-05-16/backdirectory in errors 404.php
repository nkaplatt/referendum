...
<html data-wf-site="56fd24aaaea6500c763220cf" data-wf-page="56fd24aaaea6500c763220d8">
<head>
  <meta charset="utf-8">
  <title>404</title>
...
<body>
  <div data-collapse="medium" data-animation="default" data-duration="400" data-contain="1" class="w-nav navbar">
    <div class="w-container">
      <a href="new-homepage.html" class="w-nav-brand logo-container">
  ...
  <div class="w-section page-header _404-page">
    <div class="page-header-overlay _404-page">
      <div class="w-container page-header-container centered">
        <h2 data-ix="page-title" class="page-header-title">Oops!</h2>
        <h2 data-ix="page-title-2" class="page-header-title subtitle">404:&nbsp;Page Error&nbsp;(Page Does not Exist)</h2>
        <div class="hero-buttons-wrapper">
          <a href="index.php" data-ix="hero-button" class="hero-button">Back to homepage</a>
          <a href="contact.php" data-ix="hero-button-2" class="hero-button _2">Contact us</a>
        </div>
      </div>
    </div>
  </div>
