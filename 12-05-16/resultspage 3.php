...
<body class="body">
  ...
  <div class="hero">
    <div class="w-container hero-container homepage _1">
      ...
      <h1 class="hero-title title-3">Based entirely on what you've told us on this site, this is how you seem to currently feel about trade.</h1>
      ...
      <a href="jobs.php" class="w-button hero-button">Next topic</a>
