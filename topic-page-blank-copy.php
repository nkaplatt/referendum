...
<html data-wf-site="572762c72f3e6fea5d0339d6" data-wf-page="573525a7dc186e2b55158108">
<head>
  <meta charset="utf-8">
  <title>topic page blank copy</title>
  ...
  <meta property="og:title" content="topic page blank copy">
  ...
  <div data-ix="display-none-on-load" class="w-section topic-select-section">
    <div class="w-container topic-container">
      <div class="w-row topic-row">
        <div class="w-col w-col-3 topic-colum"><img src="images/trade-01.png">
        </div>
        <div class="w-col w-col-3 topic-colum"><img src="images/defence-01.png">
        </div>
        <div class="w-col w-col-3 topic-colum"><img src="images/jobs-01.png">
        </div>
        <div class="w-col w-col-3 topic-colum"><img src="images/immi-01.png">
        </div>
      </div>
      <div class="w-row topic-row">
        <div class="w-col w-col-3 topic-colum"><img src="images/immi-01.png">
      ...
      </div><a href="#" class="w-button topic-continue">Continue</a>
    </div>
  </div>
