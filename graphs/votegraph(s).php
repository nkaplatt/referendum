...
function get_results($User_ID){
 ...
 // fclose($myIP);
  ...
  $query .= "WHERE MUser_ID = '{$User_ID}' and Category_ID = '2';";
  ...
  function pieChart(){
	  ...
	  var ctx = document.getElementById("chart-area").getContext("2d");
          window.myPie = new Chart(ctx).Pie(pieData, {
            ...
            <?php else : ?>
               <h2 style="align:center; padding:6px; display:inline; color:white; background:#c06">To get results, use our 'think' section.</h2>
            <?php endif; 
}?>