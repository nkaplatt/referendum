    ...
    <div class="hero homepage">
      <div data-collapse="none" data-animation="default" data-duration="400" data-contain="1" class="w-nav navbar">
		...
		if (isset($_SESSION['login_user'])) {
			?><nav role="navigation" class="w-nav-menu"><form action="logout.php" method="post"> <input type="submit" class="w-button hero-button" value="logout"/></form></nav> <?php
		} else {
		   ?><nav role="navigation" class="w-nav-menu"><a href="signup.php" class="w-button hero-button">Sign up/login</a> </nav> ?php } 
		 ?>
