...
<html data-wf-site="572762c72f3e6fea5d0339d6" data-wf-page="57334f6a4ce7add4662b5663">
<head>
  <meta charset="utf-8">
...
<body class="body">
  ...
  <div class="w-section page-header _404-page">
    <div class="page-header-overlay privacy">
      <div class="w-container page-header-container centered">
        <h2 data-ix="page-title" class="page-header-title">Privacy Policy</h2>
      </div>
      <div class="w-container">
        <div class="policy-card">
          <p>Welcome to our website. If you continue to browse and use this website, you are agreeing to comply with and be bound by the following terms and conditions of use, which together with our privacy policy govern leaveorstay’s relationship with you in relation to this website. If you disagree with any part of these terms and conditions, please do not use our website.
            <br>
            <br>
            <strong>The use of this website is subject to the following terms of
use:</strong>
            <br> - The content of the pages of this website is for your general information and use only.
            <br> &nbsp;- It is subject to change without notice. This website monitors browsing activities and preferences.
            <br> - If you do allow cookies to be used, the following personal information may be stored by us for use by third parties: any responses to web forms, navigation of the site, Google Analytics data, voting preference, voting intent, policy opinion, or other passing polling data.
            ...
            <br> - Your use of any information or materials on this website is entirely at your own risk, for which we shall not be liable. It shall be your own responsibility to ensure that any products, services or information available through this website meet your specific requirements. This website contains material which is owned by or licensed to us.
            <br> &nbsp;- This material includes, but is not limited to, the design, layout, look, appearance and graphics. Reproduction is prohibited other than in accordance with the copyright notice, which forms part of these terms and conditions.
            <br>
            <br> All trade marks reproduced in this website which are not the property of, or licensed to, the operator are acknowledged on the website. Unauthorised use of this website may give rise to a claim for damages and/or be a criminal offence. From time to time this website may also include links to other websites. These links are provided for your convenience to provide further information. They do not signify that we endorse the website(s). We have no responsibility for the content of the linked website(s). Your use of this website and any dispute arising out of such use of the website is subject to the laws of England, Northern Ireland, Scotland and Wales.</p><a href="index.html" data-ix="new-interaction-4" class="w-button continue-button _2">Return to home</a>
        </div>
      </div>
    </div>
  </div>
