...
<body class="body">
  ...
  <div class="hero">
    <div class="w-container hero-container homepage _1">
      ...
      <h1 class="hero-title title-3">Based entirely on what you've told us across the whole site, this is how you seem to currently feel about the EU.</h1><a href="/eu-referendum-the-basics" class="w-button hero-button">Share leaveorstay to help undecided voters</a><a href="#" class="w-button hero-button _2">Save my results for later</a>
    </div>
    <div class="w-section results">
      <div class="w-container">
        <h1 class="how-to-header topic-result">Here are your site <strong class="highlight-word result">results</strong>:</h1>
    ...
    <div class="w-container share-and-save">
      <div class="w-row">
        <div class="w-col w-col-6 save">
          <h1 class="save-and-share-header short">Come back to your results</h1>
          ...
          <div class="w-form">
            <form id="email-form" name="email-form" data-name="Email Form">
              ...
              <input id="name-2" type="text" placeholder="Enter a password" name="name-2" data-name="Name 2" required="required" class="w-input">
