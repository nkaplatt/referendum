...
<html data-wf-site="572762c72f3e6fea5d0339d6" data-wf-page="572762c72f3e6fea5d0339dd">
<head>
  <meta charset="utf-8">
  <title>404</title>
  ...
  <div class="w-section page-header _404-page">
    <div class="page-header-overlay _404-page">
      <div class="w-container page-header-container centered">
        ...
        <div class="hero-buttons-wrapper"><a href="index.html" data-ix="hero-button" class="hero-button">Back to homepage</a><a href="/contact" data-ix="hero-button-2" class="hero-button _2">Contact us</a>
        </div>
      </div>
    </div>
  </div>
